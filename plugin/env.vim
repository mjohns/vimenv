...
autocmd BufNewFile,BufRead * set colorcolumn=8000
autocmd BufNewFile,BufRead *.cc set colorcolumn=100
autocmd BufNewFile,BufRead *.h set colorcolumn=100
autocmd BufNewFile,BufRead *.cpp set colorcolumn=100
autocmd BufNewFile,BufRead *.hpp set colorcolumn=100
